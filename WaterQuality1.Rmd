...
How would you define water quality? The world health organization (WHO) define  water quality as a “ term used here to express the suitability of water to sustain various uses or processes. " (REF). From this definition it is clear that water quality is a complex concept that involve many different components. 



According to [dimensions.ai](https://www.dimensions.ai/)), the proportion of published papers in ecology ( with the term water quality has more than doubled (from 6.6% to 14% of papers) since 1980, and the occurence within in the abstract or title of ecological papers has more than tripled over the same period (0.7% to 2.3%). The increase use of the term water quality in ecology, is similar to what was observed in other fields (see FigureX). This suggest that water quality is a subject that is increasing in importance in science in general. In ecology, 
...
plot.trends()
```
*Figure 1: The temporal evolution (1980-2017) of the  proportion of paper with the term water quality in different fields and in the literature in general based on [dimensions.ai](https://www.dimensions.ai/))* 
